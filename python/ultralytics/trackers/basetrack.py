...
class BaseTrack:
    ...
    Attributes:
        _count (int): Class-level counter.py for unique track IDs.
    ...
    Methods:
        ...
        reset_id: Resets the global track ID counter.py.
    ...
    @staticmethod
    def reset_id():
        """Reset the global track ID counter.py to its initial value."""
        BaseTrack._count = 0
