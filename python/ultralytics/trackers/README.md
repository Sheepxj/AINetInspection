...
model = YOLO("path/to/Protection.pt")  # Load a custom trained model
...
yolo track model=path/to/Protection.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/Protection.pt tracker="bytetrack.yaml"
```
